...
CREATE TABLE IF NOT EXISTS usuarios (
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `uq_usuarios_email` (`email`)   -- ✅ del paste 2
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ------------------------------------------------------------
-- CATEGORÍAS
-- ------------------------------------------------------------
CREATE TABLE IF NOT EXISTS categorias (         -- ✅ recuperada del paste 1
...
CREATE TABLE IF NOT EXISTS lineas_pedidos (
    ...
    subtotal_linea   DECIMAL(12,2)     GENERATED ALWAYS AS (unidades * precio_unitario) STORED,
...
-- USUARIOS
INSERT INTO `usuarios` (`nombre`, `apellidos`, `email`, `password`, `rol`, `confirmado`) VALUES
(
    'Juan', 'García López', 'admin@tienda.com',
    '$2b$12$e7k07zkyLCKvKT98AFsyqui1daLoDtUxOaiygHetXWEwx9BzxM1Om',
    'admin', TRUE
),
(
    'Test', 'Admin', 'test@tienda.com',
    '$2b$12$nEC7vQqQLD7t9ZJ3MpKymOdUqw0MD.jpnE2Vy7TEWINo4AsCdwxhu',
    'admin', TRUE
),
(
    'María', 'Rodríguez Martínez', 'maria@email.com',
    '$2b$12$.NP5pX.Q2FyRXc9p5nGGCeGQ6laoTN2BieLIlzjIgb4x5lK5/YSvW',
    'usuario', TRUE
);
-- CATEGORÍAS
...
(1, 'Valk 2 M',                'Cubo 2x2 de alto rendimiento para competidores.',                 16.99, 14.99, 15,  1, 'https://placehold.co/300x300/555555/ffffff?text=Valk+2'),
-- Cubos 3x3
...
(2, 'Gan 12 Maglev',            'El mejor cubo 3x3 del mercado. Imanes magnéticos.',              59.99, 49.99, 15,  1, 'https://placehold.co/300x300/6a0572/ffffff?text=Gan+12+Maglev'),
(2, 'Moyu RS3M 2020',           'Excelente cubo 3x3 con magnets. Relación calidad-precio.',       19.99, 16.99, 45,  1, 'https://placehold.co/300x300/457b9d/ffffff?text=Moyu+RS3M'),
...
(2, 'X-Man Tornado 3x3',        'Cubo 3x3 económico y estable, buena opción para principiantes.',12.99, NULL,  30,  1, 'https://placehold.co/300x300/123456/ffffff?text=XMan+3x3'),
(2, 'YJ MGC 3x3',               'Buena relación calidad-precio con imanes.',                      22.99, 18.99, 20,  1, 'https://placehold.co/300x300/abcdef/000000?text=YJ+MGC'),
-- Cubos 4x4
(3, 'Rubiks Cube 4x4 Master',  'El cubo 4x4 de Rubiks. Gran desafío.',                           34.99, 27.99, 20,  1, 'https://placehold.co/300x300/e76f51/ffffff?text=Rubiks+4x4'),
...
(5, 'Cubo Espejo',             'Cubo con dimensiones diferentes. Engañosamente difícil.',         18.99, 14.99, 18,  1, 'https://placehold.co/300x300/264653/ffffff?text=Cubo+Espejo'),
(5, 'Pyraminx Magnetic',       'Pyraminx con imanes: suavidad y control.',                       24.99, 19.99, 10,  1, 'https://placehold.co/300x300/ff7f50/ffffff?text=Pyraminx+Mag'),
...
(6, 'Set Lubricantes Básico',  'Incluye 3 lubricantes para ajustar tu cubo.',                   19.99, 14.99, 80,  1, 'https://placehold.co/300x300/222222/ffffff?text=Lubricantes+Set'),
(6, 'Alicates Ajuste',         'Herramienta para ajustar tensión de cubos.',                     6.99,  NULL,  40,  1, 'https://placehold.co/300x300/808080/ffffff?text=Herramienta'),
(6, 'Set de Limpieza',         'Kit completo para limpiar y mantener tus cubos.',                14.99, 11.99, 35,  1, 'https://placehold.co/300x300/606c38/ffffff?text=Set+Limpieza');

-- ------------------------------------------------------------
-- Pedidos de ejemplo: darle compras al admin@tienda.com (usuario_id = 1)
-- ------------------------------------------------------------
INSERT INTO `pedidos` (usuario_id, provincia, localidad, direccion, subtotal, impuestos, coste_total, estado) VALUES
(1, 'Madrid', 'Madrid', 'Calle Falsa 123', 89.97, 7.20, 97.17, 'pagado');
SET @pedido1 = LAST_INSERT_ID();

INSERT INTO `lineas_pedidos` (pedido_id, producto_id, unidades, precio_unitario) VALUES
(@pedido1, 1, 2, 14.99),  -- 2 x Rubiks Cube 2x2 Clásico
(@pedido1, 6, 1, 59.99);  -- 1 x Gan 12 Maglev

INSERT INTO `pedidos` (usuario_id, provincia, localidad, direccion, subtotal, impuestos, coste_total, estado) VALUES
(1, 'Barcelona', 'Barcelona', 'Passeig de Gracia 10', 29.98, 0.00, 29.98, 'pendiente');
SET @pedido2 = LAST_INSERT_ID();

INSERT INTO `lineas_pedidos` (pedido_id, producto_id, unidades, precio_unitario) VALUES
(@pedido2, 3, 2, 5.99);   -- 2 x QiYi Qidi 2x2