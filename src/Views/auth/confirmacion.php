<div class="confirmacion-container">
    <?php if ($status === 'success'): ?>
        <div class="card success">
            ...
            <a href="<?= $_ENV['BASE_URL'] ?>/login" class="btn-login">Ir al Login</a>
        </div>
    ...
    <?php elseif ($status === 'expired'): ?>
        <div class="card warning">
            ...
            <a href="<?= $_ENV['BASE_URL'] ?>/registro" class="btn-registro">Volver a registrarme</a>
        </div>
    ...
    <?php else: ?>
        <div class="card error">
            ...
            <a href="<?= $_ENV['BASE_URL'] ?>/" class="btn-inicio">Volver al inicio</a>
        </div>
    <?php endif; ?>
</div>
